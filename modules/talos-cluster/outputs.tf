...
# Outputs of the talos-cluster module.
...
# Raw kubeconfig (server URL = the connection endpoint, un-rewritten). The
# consumer parses this to configure the kubernetes/helm/argocd providers.
output "kubeconfig_raw" {
  description = "Raw kubeconfig as minted by the Talos provider (server URL not rewritten to ts.net)."
  value       = talos_cluster_kubeconfig.this.kubeconfig_raw
  sensitive   = true
}
